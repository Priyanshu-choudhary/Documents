...
<html>
  ...
  <h1  id="para1" >Drone telemetry system</h1>
<style>
...
$(document).ready(function(){
   ...
   $("#toggle").click(function(){
    $("#main-buttons").fadeToggle("slow");
    $("#secondary-buttons").fadeToggle("slow");
  //  $("#collapseOne").fadeToggle("slow");
  });
      ...
      <div class="container-fluid text-left liveimage">
...
<div id="data1">
<!--
<button id="toggle">More option</button><br><br>
-->
...
$line_number = 1;
$line_number2 = 2;
echo "<h1>" . $lines[$line_number - 1]  .  $lines[$line_number2 - 1] .  "</h>";
?>
</div>
  ...
  <div id="secondary-buttons" class="container-fluid text-left" >
         <?php pan_controls(); ?>
         <?php user_buttons(); ?>

         <a href="preview.php" class="btn btn-default" <?php getdisplayStyle('preview', $userLevel); ?>>Download Videos & Images</a>
         &nbsp;&nbsp;
